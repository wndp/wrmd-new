...
Route::middleware([
    ...
    // // Media
    // Route::controller(MediaController::class)->middleware('can:manage-attachments')->group(function () {
    //     Route::get('{resource}/{resourceId}/media', 'index')->name('media.index');
    //     Route::post('{resource}/{resourceId}/media', 'store')->name('media.store');
    //     Route::get('{resource}/{resourceId}/media/{media}', 'edit')->name('media.edit');
    //     Route::put('{resource}/{resourceId}/media/{media}', 'update')->name('media.update');
    //     Route::delete('{resource}/{resourceId}/media/{media}', 'destroy')->name('media.destroy');
    // });
