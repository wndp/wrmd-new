...
class Rescuers extends ExportableReport
{
    /**
    ...
    {
        return __("This report lists all rescuers in your account who's patients were admitted within the date range specified.");
    }
