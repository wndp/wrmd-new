...
enum Ability: string
{
    ...
    case VIEW_EVENT_PROCESSING = 'VIEW_EVENT_PROCESSING';
    case MANAGE_EVENT_PROCESSING = 'MANAGE_EVENT_PROCESSING';
    case VIEW_EVENT_PREWASH = 'VIEW_EVENT_PREWASH';
    case MANAGE_EVENT_PREWASH = 'MANAGE_EVENT_PREWASH';
    case VIEW_EVENT_WASH = 'VIEW_EVENT_WASH';
    case MANAGE_EVENT_WASH = 'MANAGE_EVENT_WASH';
    case VIEW_EVENT_CONDITIONING = 'VIEW_EVENT_CONDITIONING';
    case MANAGE_EVENT_CONDITIONING = 'MANAGE_EVENT_CONDITIONING';
