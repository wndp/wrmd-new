...
return [
    ...
    'description' => 'The Wildlife Rehabilitation MD (WRMD) API allows you to programatically create and manage your patient resources and related data through a <a href="https://jsonapi.org/" target="_blank">JSON:API</a>.',

    // The base URL displayed in the docs. If this is empty, Scribe will use the value of config('app.url') at generation time.
    // If you're using `laravel` type, you can set this to a dynamic string, like '{{ config("app.tenant_url") }}' to get a dynamic base URL.
    'base_url' => 'https://www.wrmd.org/',
    ...
    'auth' => [
        ...
        'extra_info' => 'As a Super Admin you can generate API tokens by visiting your account settings and clicking <b>WRMD API</b>.',
    ],
