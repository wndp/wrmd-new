    ...
    <div class="relative py-8 px-4 sm:px-6 lg:px-8 bg-white">
      ...
      <div class="mt-6 prose max-w-none prose-blue text-gray-500 mx-auto">
        ...
        <ul>
          ...
          <li>
            <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using Ithe Service, as applicable.</p>
          </li>
        </ul>
        ...
        <p>By posting Content to the Service, You grant Us the right and license to use, modify, publicly perform, publicly display, reproduce, and distribute such Content on and through the Service or any service controlled by the Company. You retain any and all of Your rights to any Content You submit, post or display on or through the Service and You are responsible for protecting those rights. You agree that this license includes the right for Us to make Your Content available to other users of the Service, who may also use Your Content subject to these Terms.</p>
        ...
        <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at support@wildneighborsdp.org and include in Your notice a detailed description of the alleged infringement.</p>
        ...
        <p>
          You can contact our copyright agent via email at support@wildneighborsdp.org.
        ...
        <h2>Termination</h2>
        <p>Either party may terminate the Agreement on written notice if the other party is in apparent breach of any provision of this Terms, provided that if the breach is curable the terminating party must first give the other party a written notice describing the breach in reasonable detail and at least thirty (30) days to cure the breach.</p>
        ...
        <ul>
          <li>
            By email: <a href="mailto:support@wildneighborsdp.org?subject=WRMD%20Terms%20And%20Conditions">support@wildneighborsdp.org</a>
          </li>
          <li>
