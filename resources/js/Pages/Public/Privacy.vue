  ...
  <PublicLayout title="Privacy Policy">
    <div class="relative py-8 px-4 sm:px-6 lg:px-8 bg-white">
      ...
      <div class="mt-6 prose max-w-none prose-blue text-gray-500 mx-auto">
        <h4>Last updated: Dec 15, 2022</h4>
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to The Wild Neighbors Database Project, PO Box 421 Middletown, CA 95461.</p>
          ...
          <li>
            <p>
              <strong>Facebook Fan Page</strong> is a public profile named Wildlife Rehabilitation MD specifically created by the Company on the Facebook social network, accessible from <a
                href="https://www.facebook.com/WildlifeRehabilitationMD"
                rel="external nofollow noopener"
                target="_blank"
              >https://www.facebook.com/WildlifeRehabilitationMD</a>
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Wildlife Rehabilitation MD, accessible from <Link :href="route('home')">
                https://www.wrmd.org
              </Link>
            </p>
          </li>
        ...
        <ul>
          ...
          <li>
            <strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read &quot;Where can I change the settings for disabling, or deleting local shared objects?&quot; available at <a
        ...
        <p>
          Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: <a
        ...
        <ul>
          <li>
            ...
            <p>
              For more information on the privacy practices of Fathom Analytics, please visit the Fathom Analytics Privacy law compliance web page: <a
                href="https://usefathom.com/compliance"
                rel="external nofollow noopener"
                target="_blank"
              >https://usefathom.com/compliance</a>
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <p>
              For more information on the privacy practices of Mailchimp, please visit their Privacy policy: <a
        ...
        <p>
          The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the Facebook Fan Page <a
            href="https://www.facebook.com/WildlifeRehabilitationMD"
            rel="external nofollow noopener"
            target="_blank"
          >https://www.facebook.com/WildlifeRehabilitationMD</a>, the Company and the operator of the social network Facebook are Joint Controllers.
        </p>
        <p>
          The Company has entered into agreements with Facebook that define the terms for use of the Facebook Fan Page, among other things. These terms are mostly based on the Facebook Terms of Service: <a
        ...
        <p>
          Visit the Facebook Privacy Policy <a
            ...
            rel="external nofollow noopener"
            target="_blank"
          >https://www.facebook.com/policy.php</a> for more information about how Facebook manages Personal data or contact Facebook online, or by mail: Facebook, Inc. ATTN, Privacy Operations, 1601 Willow Road, Menlo Park, CA 94025, United States.
        </p>
        ...
        <p>
          For more information on the privacy practices of Facebook, please visit Facebook Privacy Policy here: <a
        ...
        <ul>
          <li>
            <p>By email: support@wildneighborsdp.org</p>
          </li>
          <li>
            <p>
              By visiting this page on our website: <a
                href="https://www.wrmd.org/about/contact"
                rel="external nofollow noopener"
                target="_blank"
              >https://www.wrmd.org/about/contact</a>
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            By email: <a href="mailto:support@wildneighborsdp.org?subject=WRMD%20Privacy%20Policy%20">support@wildneighborsdp.org</a>
          </li>
          <li>
            By visiting this page on our website: <Link :href="route('contact.create')">
              https://www.wrmd.org/contact
            </Link>
          </li>
        </ul>
      </div>
