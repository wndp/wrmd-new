          ...
          >
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              >
                ...
                >
                  <Checkbox
                    :id="`forbidden-${ability.name}-${role.level}`"
...
export default {
    ...
    methods: {
        saveAuthorizations() {
            this.form.put(this.route('admin.authorization.update', 'forbidden'));
        }
    }
};
</script>
