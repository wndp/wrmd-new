        ...
        <FormSection>
          ...
          <div class="col-span-4">
            ...
            <p class="mt-1 text-sm text-gray-500">
              {{ __('WildAlert is a system used for early detection of wildlife morbidity and mortality events. It provides timely, accurate information on where wildlife disease events are occurring or have occurred to facilitate decision making and improve our understanding of health threats.') }} {{ __('WildAlert uses Wildlife Rehabilitation MD data to predict when the number of patients exceeds an establish threshold for a given diseases.') }} {{ __('As a benefit to contributing to WildAlert, you will also receive notifications on your patients that may be part of an ongoing wildlife morbidity and mortality event.') }}
            </p>
            <div class="mt-2">
              <Toggle
