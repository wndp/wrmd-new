      ...
      <div class="col-span-6">
        <FormSection>
          ...
          <div class="col-span-4">
            <Label for="first-name">{{ __('Allow All Users Full Access To All People.') }}</label>
            <div class="mt-2">
              <Toggle
          ...
          <template v-else>
            ...
            <div class="col-span-4">
              <Label>{{ __('Allow These Users to Access People From the Sidebar') }}</Label>
            ...
            <div class="col-span-4">
              <Label>{{ __('Allow These Users to Access a Patients Rescuer') }}</Label>
              <div class="mt-2 space-y-2">
                <div
                  v-for="user in users"
                  :key="user.id"
            ...
            <div class="col-span-4">
              <Label>{{ __('Allow These Users to Search Rescuers When Creating a New Patient') }}</Label>
              <div class="mt-2 space-y-2">
                <div
                  v-for="user in users"
                  :key="user.id"
            ...
            <div class="col-span-4">
              <Label>{{ __('Allow These Users to Create New People') }}</Label>
              <Label class="font-normal italic">{{ __('Note: allowing a user to create people will also allow them to see people.') }}</Label>
              <div class="mt-2 space-y-2">
                <div
                  v-for="user in users"
                  :key="user.id"
            ...
            <div class="col-span-4">
              <Label>{{ __('Allow These Users to Delete People') }}</Label>
              <Label class="font-normal italic">{{ __('Note: allowing a user to delete people will also allow them to see people.') }}</Label>
              <div class="mt-2 space-y-2">
                <div
                  v-for="user in users"
                  :key="user.id"
            ...
            <div class="col-span-4">
              <Label>{{ __('Allow These Users to Combine People') }}</Label>
              <Label class="font-normal italic">{{ __('Note: allowing a user to combine people will also allow them to see people.') }}</Label>
              <div class="mt-2 space-y-2">
                <div
                  v-for="user in users"
                  :key="user.id"
            ...
            <div class="col-span-4">
              <Label>{{ __('Allow These Users to Export People') }}</Label>
              <Label class="font-normal italic">{{ __('Note: allowing a user to export people will also allow them to see people.') }}</Label>
              <div class="mt-2 space-y-2">
                <div
                  v-for="user in users"
                  :key="user.id"
