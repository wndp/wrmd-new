...
import StreamGraph from '@/Components/Analytics/StreamGraph.vue';
...
<template>
  <AppLayout title="Analytics">
    ...
    <h2 class="text-2xl font-normal text-gray-900">
      {{ __('Demographics: Dehydration') }}
    </h2>
    <GeneratedOn class="mb-4" />
    <StreamGraph
      id="patient-admission-dehydrations"
      :title="__('Patient Dehydration at Intake')"
      class="mb-4"
    />
    <AnalyticsDataTable id="patients-by-admission-dehydrations" />
  </AppLayout>
</template>
